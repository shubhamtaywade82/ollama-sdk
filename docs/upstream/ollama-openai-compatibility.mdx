<!-- Pinned from ollama/ollama@main (source file SHA: 272f98ea7ae8bf9d4cd463ebdca352793cbe1dda) on 2026-09-25. Used only as a CI fallback when live docs rendering is incomplete/unavailable. -->
