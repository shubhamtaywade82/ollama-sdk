<!-- Pinned from ollama/ollama@main (source file SHA: b57bd26b6a9551c81872bda3786e0fe975bc5085) on 2026-09-25. Used only as a CI fallback when live docs rendering is incomplete/unavailable. -->
