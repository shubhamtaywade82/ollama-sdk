...
- **Next Ollama API parity pass:** native `Message.tool_name` support for tool-result history, while retaining synthetic `tool_call_id` correlation for OpenAI-shaped consumers.
